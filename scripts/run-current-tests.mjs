...
const recentReleaseTests = readdirSync(resolve("test"))
  .filter((file) =>
    /V84(?:1[8-9]|2\d|3[0-7])\.test\.mjs$|V85\d*\.test\.mjs$|V88\d*\.test\.mjs$|V89\d*\.test\.mjs$|V9[2-6]\d*\.test\.mjs$|releaseIntegrityV881\.test\.mjs$/.test(file),
  )
...
files.push("test/healthyDinnerStandardV992.test.mjs");
...
files.push("test/crockPotMidpointEstimatesV997.test.mjs");
...
files.push("test/veganHeroFavoritesCountsV9918.test.mjs");
