...
import "./AdminNutritionDatabase.css";
    ...
    <div className="nutritionAdminWorkspace">
      ...
      {selectedRow && <section className="nutritionAdminDetail">
        ...
        {mode === "lookup" ? <>
          ...
          {inspectorTab === "products" && <section><h3>Products & Sauces</h3><p>No product-dependent component records are stored for this recipe.</p><p><b>Product selection:</b> Healthier nutritional suitability first; retailer order is only a tiebreaker among acceptable choices.</p><p><b>Retailer tiebreaker:</b> Walmart / Great Value, H-E-B, Kroger, generic fallback.</p><p><b>Sauce priority:</b> lowest-practical sodium with reasonable added sugar, with mapped MHS alternatives preferred where applicable.</p><p>Unavailable options are marked: <b>Not yet defined</b>.</p></section>}
