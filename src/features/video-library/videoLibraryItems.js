...
export const VIDEO_LIBRARY_ITEMS = [
  ...
  availableVideo("diet-meals", "Diet Meals", "Explore the lighter Diet Meals rotation and related Diet Meals collection.", "diet-meals", "Healthy Dinners", "Open Diet Meals"),
  ...
  availableVideo("healthy-dinners", "Diet Meals", "Explore the Diet Meals collection and its lighter meal choices.", "diet-meals", "Healthy Dinners", "Open Diet Meals"),
