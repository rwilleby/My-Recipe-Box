...
const PAGE_ROUTE_OVERRIDES = {
  ...
  Recipes: "/recipes/",
  "Vegan Recipe Library": "/vegan-recipes/",
  "Dinner Combinations": "/complete-dinners/",
  "Complete Dinners": "/collections/recipes-for-complete-dinners/",
  Favorites: "/favorites/",
  "Meal Planner": "/meal-planner/",
  "Build Your Own Meal": "/build-your-own-meal/",
  "Shopping Lists": "/shopping-list/",
  "Master Kitchen Inventory": "/kitchen-inventory/",
  "Food Storage Guide": "/food-storage-and-shelf-life-guide/",
  "Freezer Label Maker": "/freezer-label-maker/",
  ...
  "Holidays and Special Occasions": "/holidays-and-special-occasions/",
...
export const ROUTABLE_PAGE_IDS = [
  ...
  "Free To Use", "Freezer Inventory Management", "Freezer Label Maker", "Freezer Tips",
  "Food Storage Guide",
  ...
  "Shopping Lists", "Slow Cooker Favorites", "Holidays and Special Occasions", "Smart Grocery Picks", "Smoker Recipes",
...
const PRIVATE_PAGE_IDS = new Set([
  ...
  "Build Your Own Meal", "Freezer Inventory Management", "Freezer Label Maker", "Kitchen Freezer", "Kitchen Refrigerator", "Master Kitchen Inventory", "Meal Planner",
...
const PAGE_TITLES = {
  ...
  "Products I Use": "Recommended Kitchen Tools & Storage",
  "Safe Cooking Rules": "Food Safety",
  "GLP-1 Nutrition": "Eating Well with GLP-1 Medications",
  "Air Fryer Recipes": "Air Fryers",
  "Microwave Recipes": "Microwave Ovens",
  "Oven Recipes": "Gas & Electric Ovens",
  "Griddle Recipes": "Gas & Electric Griddles",
  "Gas Grill Recipes": "Gas Grills",
  "Smoker Recipes": "Pellet Smokers",
};
...
const PAGE_DESCRIPTIONS = {
  ...
  "Vegan Recipe Library": "Browse verified vegan recipes prepared without meat, seafood, dairy, eggs, honey, or other animal-derived ingredients.",
  "Dinner Combinations": "Browse ready-made Complete Dinners pairing an approved main dish with practical sides, whole-meal nutrition estimates, planning tools, and freezer guidance.",
  "Healthy Dinners": "Compare Diet Meals by protein, cuisine, calories, and MealBalance, with complete recipe cards and estimated nutrition.",
  ...
  "Holidays and Special Occasions": "Choose complete three-dish menu ideas for holidays and special occasions throughout the year, with recipe-card, meal-planning, and grocery-list connections.",
  ...
  "Food Storage Guide": "Review practical refrigerator, freezer, pantry, thawing, packaging, labeling, rotation, and food-discard guidance.",
  "Freezer Label Maker": "Create, preview, save, and print freezer labels for individual portions, Complete Dinners, and bulk-prepared ingredients.",
  ...
  "Grocery Picks": "Review practical recipe substitutions and adjustments for sodium, carbohydrates, plant-based cooking, dairy, portions, appliances, and ingredient availability.",
