...
export const ROUTABLE_PAGE_IDS = [
  ...
  "Collections", "Comfort Foods", "Complete Dinners", "Contact Me", "Cooking Methods",
...
const PRIVATE_PAGE_IDS = new Set([
  ...
  "Freezer Inventory Management", "Kitchen Freezer", "Kitchen Refrigerator", "Master Kitchen Inventory", "Meal Planner",
