...
export const HOW_IT_WORKS_GUIDES = [
  ...
  {
    id: "vegan-recipe-library",
    title: "Vegan Recipe Library",
    category: "Finding Recipes",
    purpose: "Find recipes that are verified vegan as written, then search, filter, save, or plan them using the regular Recipe Box tools.",
    steps: [
      "Choose All Vegan Recipes or a visible vegan-qualified category.",
      "Search or filter within the verified vegan recipe set.",
      "Select a recipe to open its complete recipe card and supporting information.",
      "Favorite the recipe or add it to your meal plan when it fits your needs.",
    ],
    features: ["Verified vegan recipes", "Vegan-only search and filters", "Recipe cards", "Favorites and planning"],
    tip: "Only recipes that are vegan as written appear here; recipes requiring substitutions remain outside this library.",
    page: "Vegan Recipe Library",
    centralAnchor: "guide-vegan-recipe-library",
  },
  {
    id: "complete-dinners",
    ...
    features: ["Ready-made dinner pairings", "Whole-meal nutrition", "Recipe-card links", "Planner connection"],
    tip: "Choose Complete Dinners for dishes already paired together; choose Build-A-Meal when you want to select your own main dish and sides.",
  ...
  {
    id: "holidays-special-occasions",
    title: "Holidays and Special Occasions",
    category: "Building and Planning Meals",
    purpose: "Choose a celebration and review its featured main dish with two complementary sides as one complete menu.",
    steps: [
      "Choose one of the occasions from the selector.",
      "Review the featured main dish, Side 1, and Side 2 together.",
      "Open any available recipe card for complete cooking instructions.",
      "Add the available menu recipes to the Meal Planner or Grocery List.",
    ],
    features: ["Nineteen occasions", "Complete three-dish menus", "Recipe-card links", "Planner and grocery-list connections"],
    tip: "Menu positions remain visible when a recipe card is still being prepared, so the featured menu is never silently changed.",
    page: "Holidays and Special Occasions",
    centralAnchor: "guide-holidays-special-occasions",
  },
  {
    id: "meal-builder",
    title: "Meal Builder",
...
const GUIDE_ID_BY_PAGE = new Map([
  ...
  ["Holidays and Special Occasions", "holidays-special-occasions"],
