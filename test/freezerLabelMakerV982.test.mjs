...
assert.match(css, /\.freezerImageLabel>h3\{[^}]*left:\.25in;right:\.25in/);
assert.match(css, /\.freezerImageLabel>h3\{[^}]*font:800 10pt\/1 Arial/);
assert.match(css, /freezerImageLabelDates/);
assert.match(css, /\.freezerImageLabel p\{[^}]*font:400 3pt\/1\.1 Arial/);
assert.match(css, /-webkit-line-clamp:2/);
assert.match(css, /freezerNutritionFacts header span\{font:400 7pt\/1/);
assert.match(css, /freezerNutritionValues small\{font:400 5pt\/1/);
assert.match(css, /freezerNutritionValues b\{[^}]*font:800 10pt\/1/);
