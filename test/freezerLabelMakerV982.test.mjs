...
assert.match(css, /font-size:4\.125pt/);
assert.match(css, /freezerNutritionValues small\{font:600 5pt\/1/);
assert.match(css, /freezerNutritionValues b\{[^}]*font:800 9pt\/1/);
