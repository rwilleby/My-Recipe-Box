...
assert.match(css, /\.freezerImageLabel>h3\{[^}]*font-family:Arial[^}]*font-size:10pt!important[^}]*font-weight:800!important/);
assert.match(css, /freezerImageLabelDates/);
assert.match(css, /\.freezerImageLabel \.freezerImageLabelCopy p\{[^}]*font-family:Arial[^}]*font-size:7pt!important[^}]*font-weight:400!important/);
assert.match(css, /-webkit-line-clamp:2/);
assert.match(css, /freezerNutritionFacts header span\{[^}]*font-size:7pt!important[^}]*font-weight:400!important/);
assert.match(css, /freezerNutritionValues small\{[^}]*font-size:6\.5pt!important[^}]*font-weight:400!important/);
