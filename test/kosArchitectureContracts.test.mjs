...
const required = [
  ...
  "OpportunityService", "createKosPlatform"
];
...
for (const prop of ["repository", "inventory", "production", "assembly", "packaging", "lineage", "workflow", "intents", "actions", "protection", "assistant", "timeline", "memory", "templates", "opportunities"]) {
