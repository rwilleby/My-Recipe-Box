...
assert.match(styles, /\.masterInventoryLedger \{[^}]*minmax\(150px, 1\.3fr\)[^}]*minmax\(104px, \.85fr\)/s);
...
assert.deepEqual(forms("Ground Beef").map((item) => item.variation), [
  "80/20 raw", "90/10 cooked", "90/10 raw", "93% lean raw", "97/3 raw", "Lean cooked", "Lean raw",
]);
assert.deepEqual(forms("Chicken").map((item) => item.variation), [
  "Cooked chicken breast, diced",
  "Cooked chicken breast, shredded",
  "Cooked chicken breast, sliced",
  "Cooked chicken breast, whole",
  "Raw bone-in thighs",
  "Raw boneless skinless breasts",
  "Raw boneless skinless thighs",
  "Raw drumsticks",
  "Raw leg quarters",
  "Raw whole chicken",
  "Raw wings",
