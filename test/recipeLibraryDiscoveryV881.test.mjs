...
assert.match(component, /const FEATURED_RECIPE_COUNT = 5/);
...
assert.match(component, /<RecipeImage recipe=\{recipe\} \/>/);
...
assert.match(css, /\.libraryCategorySelectorText,[\s\S]*aspect-ratio: 1\.48 \/ 1/);
