...
assert.match(releaseCss, /main\.browseRecipesPage:not\(\.veganRecipeLibraryPage\) \.recipeGrid\.browseRecipeGrid\.browseCompactRecipeGrid[\s\S]*?repeat\(3, minmax\(0, 1fr\)\)/);
