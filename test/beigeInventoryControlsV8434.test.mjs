...
for (const label of ["MY CURRENT INVENTORY", "All Items", "Low Stock", "Expiring Soon", "Add to Inventory"]) assert.ok(kitchen.includes(label), `Missing current-inventory control: ${label}`);
...
assert.match(kitchen, /itemHasSavedRecord/);
