...
assert.equal(recipes.length, 763, "the authoritative recipe catalog must include the Stage 1 Vegan sister recipe");
assert.equal(new Set(recipes.map(({ id }) => id)).size, 763, "recipe codes must be unique");
