...
assert.equal(recipes.length, 778, "the authoritative recipe catalog must include all approved Vegan sister recipes");
assert.equal(new Set(recipes.map(({ id }) => id)).size, 778, "recipe codes must be unique");
