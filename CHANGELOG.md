...
- Reworked Browse Our Recipe Library into a category-led discovery area with one full-size cuisine selector card and four homepage-sized hero-image recipe previews in a locked single row; the selector now clearly invites visitors to select a cuisine, while each recipe preview keeps its title, calories, and MealBalance without extra description copy. Dynamic centered category copy, Favorites support, reduced-motion protection, and the complete filterable listing remain intact.
...
- Replaced broad four-item Diet Meal estimates with 100 individually checkable structured ingredient records, bringing DM-001 through DM-050 to 515 verified records.
- Assigned practical Shopping List aisles while preserving recipe-card wording and exact quantities.
- Added regression coverage for all ten card-level counts, representative exact quantities, aisle assignments, and the remaining fallback boundary at DM-051.

# v84.4 — Diet Meal Ingredient Data, Batch 4

- Transcribed and visually verified every ingredient and quantity from recipe cards DM-031 through DM-040.
- Replaced broad four-item Diet Meal estimates with 105 individually checkable structured ingredient records, bringing DM-001 through DM-040 to 415 verified records.
- Assigned practical Shopping List aisles while preserving recipe-card wording and exact quantities.
- Split five “garlic and ginger” card lines into separate ingredient records so each pantry item can be checked independently.
- Added regression coverage for card-level counts, representative exact quantities, aisle assignments, and the remaining fallback boundary at DM-041.
...
- Replaced broad four-item Diet Meal estimates with 105 individually checkable structured ingredient records, bringing DM-001 through DM-020 to 217 verified records.
- Assigned practical Shopping List aisles while preserving the recipe-card wording and exact quantities.
- Split combined seasoning lines into separate ingredient records when separate checkboxes improve inventory decisions.
- Added regression coverage for card-level counts, representative exact quantities, aisle assignments, and the remaining fallback boundary at DM-021.
